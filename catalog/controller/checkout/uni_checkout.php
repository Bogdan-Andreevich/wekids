...
class ControllerCheckoutUniCheckout extends Controller {
	...
	public function validate() {
		...
		if (!$this->config->get('config_checkout_guest') && !$this->customer->isLogged() && !isset($uniset['checkout_passgen']) && !$password) {
	...
	public function shipping_method() {
		...
		if(isset($this->request->post['shipping_method']) && $this->session->data['shipping_method']['code'] != $this->method_pickup_code) {
		...
		if((!isset($this->session->data['shipping_method']) || !$this->session->data['shipping_method']['code']) && $method_data) {
