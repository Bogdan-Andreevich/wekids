...
class ControllerExtensionModuleUniTool extends Controller {
	...
	private function setGeneratedStyle($generated_file) {
		...
		$style .= '.menu-module__a, .menu-module__a:focus, .menu-module__children-a,  a.list-group-item{color:#'.$uniset['sidebar_menu']['color'].'}';
		...
		if($uniset['menu_type'] == 1) {
			...
			$style .= '.menu-right .menu__level-1-a, .menu-right .menu__level-1-li:after{color:#'.$uniset['right_menu']['col'].'}';
			$style .= '.menu-right .menu__level-1-li:hover .menu__level-1-a{color:#'.$uniset['right_menu']['col_hov'].'}';
		...
		//unislideshow
		$style .= '.uni-slideshow__title, .uni-slideshow_v2__title{color:#'.$uniset['unislideshow_title_color'].'}';
		$style .= '.uni-slideshow__text, .uni-slideshow_v2__text{color:#'.$uniset['unislideshow_text_color'].'}';
		$style .= '.uni-slideshow__btn, .uni-slideshow__btn:hover, .uni-slideshow__btn:focus, .uni-slideshow_v2__btn, .uni-slideshow_v2__btn:hover, .uni-slideshow_v2__btn:focus{color:#'.$uniset['unislideshow_button_color'].';background:#'.$uniset['unislideshow_button_bg'].'}';
		$style .= '.uni-slideshow .owl-nav button, .uni-slideshow_v2 .owl-nav button{color:#'.$uniset['unislideshow_nav_bg_active'].'}';
		$style .= '.uni-slideshow .owl-dots .owl-dot span, .uni-slideshow_v2 .owl-dots .owl-dot span{background:#'.$uniset['unislideshow_nav_bg'].'}';
		$style .= '.uni-slideshow .owl-dots .owl-dot.active span, .uni-slideshow_v2 .owl-dots .owl-dot.active span{background:#'.$uniset['unislideshow_nav_bg_active'].'}';
			
		//home text banners
		$style .= '.home-banner__item{background:#'.$uniset['home']['text_banner']['color']['bg'].'}';
		$style .= '.home-banner__icon{color:#'.$uniset['home']['text_banner']['color']['icon'].'}';
		$style .= '.home-banner__text{color:#'.$uniset['home']['text_banner']['color']['text'].'}';
		...
		$style .= '.wishlist, .wishlist a{color:#'.$uniset['wishlist']['btn_color'].';background:#'.$uniset['wishlist']['btn_bg'].'}';
		$style .= '.wishlist:hover, .wishlist a:hover, .wishlist.active{color:#'.$uniset['wishlist']['btn_color_hover'].';background:#'.$uniset['wishlist']['btn_bg_hover'].'}';
		$style .= '.compare, .compare a{color:#'.$uniset['compare']['btn_color'].';background:#'.$uniset['compare']['btn_bg'].'}';
		$style .= '.compare:hover, .compare a:hover, .compare.active{color:#'.$uniset['compare']['btn_color_hover'].';background:#'.$uniset['compare']['btn_bg_hover'].'}';
		...
		$style .= '.product-banner__item{background:#'.$uniset['product']['text_banner']['color']['bg'].'}';
		$style .= '.product-banner__icon{color:#'.$uniset['product']['text_banner']['color']['icon'].'}';
		$style .= '.product-banner__text{color:#'.$uniset['product']['text_banner']['color']['text'].'}';
		...
		$style .= '@media (max-width:767px){';
			if($is_background) {
				$style .= 'body{background:none !important} .uni-wrapper {padding:0 !important}';
				
				if(isset($uniset['background_old_type'])) {
					$style .= 'body{background:none !important} .uni-wrapper {padding:0 !important}';
				} else {
					$style .= '.uni-wrapper{margin:0 0 20px;padding:15px;background:#fff;border-radius:4px}';
				}
			}
		...
		$style .= '@media (min-width:992px){';
			...
			$style .= '.main-menu.set-before:before{background:#'.($uniset['menu_type'] == 1 ? $uniset['right_menu']['bg'] : $uniset['main_menu2_bg']).'}';
		...
		$style = str_replace('#000000', '#000', $style);
		$style = str_replace('#111111', '#111', $style);
		$style = str_replace('#222222', '#222', $style);
		$style = str_replace('#333333', '#333', $style);
		$style = str_replace('#444444', '#444', $style);
		$style = str_replace('#555555', '#555', $style);
		$style = str_replace('#666666', '#666', $style);
