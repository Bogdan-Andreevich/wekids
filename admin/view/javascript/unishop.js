...
$(function() {
	...
	function addHeaderLinks(lang_id, data) {
		...
		html += '<input type="text" name="uni_set['+lang_id+'][headerlinks]['+headerlinks_num+'][title]" value="" placeholder="'+uni_placeholder_heading+' #'+headerlinks_num+'" class="form-control" />';
		html += '<input type="text" name="uni_set['+lang_id+'][headerlinks]['+headerlinks_num+'][link]" value="" placeholder="'+uni_placeholder_link+' #'+headerlinks_num+'" class="form-control" />';
		...
		html += '<a data-toggle="dropdown" data-target="infolink-list-headerlinks">'+uni_text_article_link+'</a>';
		html += data;
		html += '</div>';
	...
	function addHeaderLinks2(lang_id, data, elem) {
		...
		html += '</div>';
		html += '<div class="infolink">';
		html += '<a data-toggle="dropdown" data-target="infolink-list-headerlinks2">'+uni_text_article_link+'</a>';
		html += data;
		html += '</div>';
...
///////////////////
	...
	function addLandingLinksItemLinks(item, languages) {
		...
		html += '<input type="text" name="uni_set[menu][landinglinks]['+cat_id+']['+key+'][link]['+languages[i]['language_id']+']" value="" placeholder="'+uni_placeholder_link+'" data-key="'+key+'" data-lang-id="'+languages[i]['language_id']+'" class="ll-link form-control" />';
		html += '</div>';
		html += '</div>';
		}
		html += '</div>';
	...
	function addProductTextblock(languages) {
		...
		for (i in languages) {
			...
			html += '<textarea name="uni_set[product][textblock][category]['+key+'][text]['+languages[i]['language_id']+']" data-lang-id='+languages[i]['language_id']+' class="form-control"></textarea>';
			html += '</div>';
		}
		html += '</div>';
		html += '<br />';
	...
	function addProductTextblock2(languages) {
		...
		html += '<ul class="nav nav-tabs">';
		for (i in languages) {
			html += '<li><a href="#textblock-manufacturer-'+key+'-'+languages[i]['language_id']+'" data-toggle="tab"><img src="language/'+languages[i]['code']+'/'+languages[i]['code']+'.png" title="'+languages[i]['name']+'" /></a></li>';
		}
		html += '</ul>';
		html += '<div class="tab-content">';
		for (i in languages) {
			html += '<div id="textblock-manufacturer-'+key+'-'+languages[i]['language_id']+'" class="tab-pane">';
			html += '<textarea name="uni_set[product][textblock]['+key+'][manufacturer][text]['+languages[i]['language_id']+']" data-lang-id='+languages[i]['language_id']+' class="form-control"></textarea>';
			html += '</div>';
		}
		html += '</div>';
		html += '<br />';
